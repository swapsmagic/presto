...
public final class TestRMQueryRunnerUtil
{
    private TestRMQueryRunnerUtil() {}
    ...
    public static QueryId createQuery(DistributedQueryRunner queryRunner, int resourceManager, Session session, String sql)
    {
        RMDispatchManager dispatchManager = queryRunner.getResourceManager(resourceManager).getRMDispatchManager();
    ...
    public static void waitForQueryState(DistributedQueryRunner queryRunner, int resourceManager, QueryId queryId, QueryState expectedQueryState)
            throws InterruptedException
    {
        waitForQueryState(queryRunner, resourceManager, queryId, ImmutableSet.of(expectedQueryState));
    }
    ...
    public static void waitForQueryState(DistributedQueryRunner queryRunner, int resourceManager, QueryId queryId, Set<QueryState> expectedQueryStates)
            throws InterruptedException
    {
        RMDispatchManager dispatchManager = queryRunner.getResourceManager(resourceManager).getRMDispatchManager();
    ...
    public static void waitForQueryState(RMDispatchManager dispatchManager, QueryId queryId, Set<QueryState> expectedQueryStates)
            throws InterruptedException
    {
        do {
