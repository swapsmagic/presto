...
/**
 * This class defines the Query dispatch process handled by RM Dispatch Manager
 */
public class RMDispatchManager
{
    ...
    private boolean queryCreated(DispatchQuery dispatchQuery)
    {
        ...
        if (queryAdded) {
            dispatchQuery.addStateChangeListener(newState -> {
                if (newState == QueryState.DISPATCHED) {
